...
export function start() {
  let pcBootstrap, APP;
  const {ASSET_PREFIX,SCRIPT_PREFIX,SCENE_PATH,CONTEXT_OPTIONS,SCRIPTS,CONFIG_FILENAME,INPUT_SETTINGS,PRELOAD_MODULES} = setting();
  (function() {
    // Shared Lib
...
(function () {
    ...
    try {
        APP = app = new pc.Application(canvas, {
