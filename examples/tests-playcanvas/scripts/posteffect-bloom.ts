...
export function bloomScript() {
  ...
  class BloomEffect extends pc.PostEffect {
    extractShader: pc.Shader;
    blurShader: pc.Shader;
    combineShader: pc.Shader;
    targets: pc.RenderTarget[];
    ...
    render(
      inputTarget: { colorBuffer: any },
      outputTarget: pc.RenderTarget,
      rect: pc.Vec4 | undefined,
    ) {
