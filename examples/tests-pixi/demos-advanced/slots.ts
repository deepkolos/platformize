...
export function Slots(canvas: any) {
  ...
  app.loader
    .add('examples/assets/eggHead.png', 'https://pixijs.io/examples/examples/assets/eggHead.png')
    .add(
      'examples/assets/flowerTop.png',
      'https://pixijs.io/examples/examples/assets/flowerTop.png',
    )
    .add('examples/assets/helmlok.png', 'https://pixijs.io/examples/examples/assets/helmlok.png')
    .add('examples/assets/skully.png', 'https://pixijs.io/examples/examples/assets/skully.png')
    .load(onAssetsLoaded);

  const REEL_WIDTH = canvas.width / 5;
  const SYMBOL_SIZE = canvas.width / 5;
  ...
  function onAssetsLoaded() {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      const reel = {
        container: rc,
        symbols: [] as unknown as PIXI.Sprite[],
        position: 0,
        previousPosition: 0,
